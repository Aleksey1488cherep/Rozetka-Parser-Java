...
public class ParserSite {
    ...
    private List<ProductAndSearch> addInformationToListFromPage(Elements adElements, List<ProductAndSearch> infoList, int pageNumber, String whatSearch) {

        for (Element productElement : adElements) {
            ProductAndSearch searchInfo = new ProductAndSearch();
    ...
    private List<ProductAndSearch> informationFromOtherPages(List<ProductAndSearch> infoPage, WebDriver connectDriver, int pageNumber, String whatSearch, int pageCount) {
    ...
    public List<ProductAndSearch> parsingPerRequestOnRozetka(String whatSearch) throws InterruptedException {

        int pageNumber = 1, pageCount;

        List<ProductAndSearch> info = new ArrayList<>();
